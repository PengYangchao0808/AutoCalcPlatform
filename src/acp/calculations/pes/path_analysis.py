"""Path profile analysis for xTB PATH and ORCA scan paths.

Migrated from ``mechanism/primitives/path_profile.py``.
...
from .validation import _canonicalize_bond_pairs, check_scan_trajectory
