...
def suggest_mechanism_plan(
    ...
    *,
    ...
    they contribute no monitor coordinates (P1: acceptable).
    """
    ...
    if not drive_specs:
        raise ValueError("Cannot suggest a mechanism plan without at least one bond change")
