...
└── solvent_map.py        # SOLVENT_ALIASES, gaussian_pcm_keyword, orca_smd_solvent (49 lines)
```

## WHERE TO LOOK
| Task | File | Notes |
|------|------|-------|
| XYZ/GJF I/O | `file_io.py` | `read_xyz`, `write_xyz`, `read_gjf`, `write_gjf` |
...
| Solvent mapping | `solvent_map.py` | `gaussian_pcm_keyword`, `orca_smd_solvent` |
